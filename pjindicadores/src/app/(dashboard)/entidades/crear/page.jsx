  ...
  const abrirModalCreacion =
    () => {
      ...
      Swal.fire({
        ...
        title:
          `
          <span class="text-white italic font-black uppercase text-xl">
            Nueva Entidad
          </span>
        `,
        ...
        html: `
          <div class="p-4 flex flex-col gap-5 text-left">
            ...
            <div>
              ...
              <label class="block text-[10px] uppercase text-slate-500 font-black mb-2">
                Logo
              </label>
              ...
              <input
                ...
                type="file"
                accept="image/*"
                class="w-full bg-[#12141d] border border-slate-800 rounded-2xl p-3 text-white"
              />
  ...
  const verPassword =
    () => {
      ...
      Swal.fire({
        ...
        text:
          'La contraseña no puede ser visualizada',
                    ...
                    >
                      ...
                      {entidad.logo ? (
                        ...
                        <img
                          ...
                          src={`
                            http://localhost:4000${entidad.logo}
                          `}
